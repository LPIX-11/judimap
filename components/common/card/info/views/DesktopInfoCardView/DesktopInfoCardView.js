...
export default function DesktopInfoCardView({ title, description, image = 'black_woman.webp' }) {
  return (
    <div className={infoCardStyle.card}>
      ...
      <div className={'position-absolute bg-white'} style={{ height: 219, width: '100%', top: 311, left: 0, opacity: .9 }}></div>
      <div className={'position-absolute px-3'} style={{ top: 239, zIndex: 1, left: 0 }}>
